    ...
    <div className="min-h-screen bg-white text-black pt-28 pb-16 px-6 md:px-8 lg:px-12">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mb-4 font-medium">
          IMPORTANTE: le invitamos a que lea detenidamente esta Política de Privacidad para conocer
          por qué recopilamos sus datos personales y cómo son procesados dichos datos por Bivo
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">ÁMBITO</h2>
          <p className="mb-4">
            Esta declaración de privacidad en línea de Bivo Training S.L., es pública y accesible a
            todos los usuarios y clientes de Bivo Training S.L., y se aplica a todos los sitios web,
            aplicaciones, eventos y otros servicios de Bivo Training S.L., siendo{" "}
            <a href="https://www.bivotraining.com/" className="text-bivo-green hover:underline">
              https://www.bivotraining.com/
            </a>{" "}
            el sitio o dominio principal.
          </p>
          <p className="mb-4">
            También se aplica a aquellos documentos o mensajes emitidos por Bivo Training S.L. que
            enlazan a esta política o declaración de privacidad o, en su caso, indican que se acceda
            a ella para que Ud. conozca el uso que hace Bivo Training S.L. de sus datos personales.
          </p>
          <p className="mb-4">
            Algunos servicios pueden tener sus propias políticas de privacidad. Si es así, esas
            políticas se aplican en lugar de esta.
          </p>
          <p className="mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">INFORMACIÓN PERSONAL QUE RECOGEMOS</h2>
          <p className="mb-4">
            Información sobre el uso de datos de carácter personal, según lo dispuesto en el
            ...
            Digitales, que adapta el Reglamento al ordenamiento jurídico español y completa y
            desarrolla sus disposiciones (LOPDGDD).
          </p>
          <p className="mb-4">
            Bivo Training S.L., respeta su derecho a la intimidad y aplica toda la normativa
            vigente con objeto de proteger los datos personales de sus clientes y usuarios.
          </p>
          <p className="mb-4">
            Sus datos personales son tratados con la máxima confidencialidad, habiendo adoptado Bivo
            Training S.L., como Responsable del Tratamiento, las medidas de orden técnico y
            organizativo necesarias para garantizar la confidencialidad y seguridad de los datos
            personales, evitando su alteración, pérdida, tratamiento o acceso no autorizado.
          </p>
          <p className="mb-4">
            Para que Usted pueda recibir información y, en su caso, poder reservar o usar los
            productos y servicios que Bivo Training S.L., ofrece a través del/de los sitio/s de Bivo
            Training S.L., es necesario que nos informe de ciertos datos personales necesarios para
            poder, así, personalizarle nuestros servicios y ajustarlos a sus intereses y necesidades.
          </p>
          <p className="mb-4">
            Le recordamos que es deber del usuario hacernos saber cualquier cambio que se produzca
            en sus datos, a Bivo Training S.L., y que hubiera registrado nuestros sitios, para
            proceder a su mantenimiento en los ficheros correspondientes.
          </p>
          <p className="mb-4">
            Para mejorar los servicios que le ofrecemos, es posible reciba una encuesta de
            satisfacción. En ella se le pedirá una valoración de los servicios recibidos y un breve
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">MODOS DE RECOGIDA</h2>
          <p className="mb-4">
            Bivo Training S.L., recoge datos personales a través de varios canales: en el sitio web{" "}
            <a href="https://www.bivotraining.com/" className="text-bivo-green hover:underline">
              https://www.bivotraining.com/
            </a>
            ; en el centro de atención telefónica de Bivo Training S.L.
          </p>
          <p className="mb-4">
            En todo caso y siempre que sea aplicable le daremos la opción de negarse a que usemos
            sus datos con fines de envíos o comunicaciones publicitarias.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">CÓMO USAMOS SU INFORMACIÓN</h2>
          <p className="mb-4">
            Utilizamos su información personal para ofrecer, mantener y mejorar nuestros servicios,
            garantizando su seguridad y optimizando su experiencia en nuestra plataforma. Nuestro
            objetivo es brindarle una experiencia segura y personalizada, al tiempo que cumplimos con
            todas las obligaciones legales correspondientes. Los usos específicos de su información
            incluyen:
          </p>
          <ul className="list-disc list-inside ml-4 mb-4 space-y-2">
          ...
          <p className="mb-4">
            ...
            personalizar entrenamientos, generar recomendaciones y mejorar el servicio. Estos
            tratamientos tienen carácter técnico y funcional, no constituyen decisiones automatizadas
            con efectos jurídicos sobre el Usuario ni diagnóstico médico.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">CÓMO COMPARTIMOS SU INFORMACIÓN</h2>
          <p className="mb-4">
            Principalmente, compartimos su información con otros miembros de la plataforma, así como
            con proveedores de servicios y socios que nos ayudan a gestionar y mejorar nuestros
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">COMUNICACIÓN A TERCEROS</h2>
          <p className="mb-4">
            Nos comprometemos a garantizar que sus datos personales estén protegidos,
            independientemente de dónde se procesen o almacenen. En determinadas circunstancias, sus
            datos podrán ser tratados o transferidos a países fuera del Espacio Económico Europeo
            (EEE), por ejemplo cuando utilizamos proveedores tecnológicos o servicios de
            infraestructura necesarios para el funcionamiento, desarrollo, mantenimiento y
            almacenamiento de la Plataforma, tales como servicios de alojamiento, bases de datos,
            analítica o herramientas tecnológicas (por ejemplo, Google, Firebase, Vercel u otros
            proveedores equivalentes). En tales casos, BIVO TRAINING aplicará las garantías legales
            adecuadas conforme a la normativa de protección de datos aplicable para asegurar un nivel
            de protección equivalente al del EEE.
          </p>
          <p className="mb-4">
            Cuando transferimos sus datos personales fuera del EEE, nos aseguramos de que dichas
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            ...
            respecto a sus datos personales, y hemos implementado herramientas y configuraciones para
            ayudarlo a ejercer estos derechos.
          </p>
          ...
          <p className="mb-4">
            Tras la eliminación de la cuenta, los datos personales serán bloqueados y conservados
            únicamente durante los plazos necesarios para el cumplimiento de obligaciones legales o
            para la atención de posibles responsabilidades, tras lo cual serán eliminados o
            anonimizados de forma segura.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">TRATAMIENTOS Y USOS</h2>
          <p className="mb-4">
            Usted podrá revocar en todo momento la autorización que haya otorgado a fin de permitir
            que sus datos sean utilizados de una manera específica. Dicha revocación de autorización
          ...
          <p className="mb-4">
            ...
            tiempo necesario para la ejecución de la relación contractual y para atender posibles
            responsabilidades derivadas del servicio prestado, con carácter general durante un plazo
            de cinco (5) años.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Cuando la contratación se realice a través de plataformas de terceros, como Apple App
            Store o Google Play, la gestión del pago y facturación será realizada por dichas
            plataformas conforme a sus propias condiciones, sin perjuicio de que BIVO TRAINING pueda
            tratar los datos necesarios para la gestión del servicio, control de suscripciones y
            cumplimiento de obligaciones legales.
          </p>
          <p className="mb-6">
            Sobre este tratamiento de datos, el Usuario podrá ejercer, cuando lo considere oportuno,
            los derechos de acceso y rectificación en los términos previstos en la normativa
            aplicable.
          </p>
          ...
          <p className="mb-4">
            Para cumplir con nuestros compromisos de calidad con el cliente, puntualmente realizamos
            una encuesta destinada a conocer la satisfacción con los trabajos realizados a nuestros
            clientes y usuarios para, así, poder mejorar nuestros servicios.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            encuesta de calidad únicamente serán utilizados si usted nos otorga su consentimiento
            explícito.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Para mantenerle informado sobre los servicios prestados por Bivo Training S.L. y de las
            promociones puntuales, precisamos tratar sus datos de contacto.
          </p>
          <p className="mb-4">
            Por otra parte, en cada comunicación enviada se le ofrecerá la oportunidad de darse de
          ...
          <p className="mb-4">
            Al navegar por BIVO TRAINING se pueden recoger datos no identificables, que pueden
            incluir, direcciones IP, ubicación geográfica, un registro de cómo se utilizan los
            servicios y sitios, y otros datos que no pueden ser utilizados para identificar al
            usuario. Entre los datos no identificativos están también los relacionados a tus hábitos
            de navegación a través de servicios de terceros.
          </p>
          <p className="mb-4">
            Utilizamos esta información para analizar tendencias, intereses de los usuarios,
            administrar el sitio, rastrear los movimientos de los usuarios alrededor del sitio y para
            recopilar información demográfica sobre nuestra base de usuarios en su conjunto.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            ...
            mecanismos de consentimiento conforme a la normativa de cookies aplicable.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">EJERCICIO DE DERECHOS</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Las solicitudes de datos enviadas pueden requerir que usted proporcione la documentación
            adicional necesaria para confirmar su identidad.
          </p>
          <p className="mb-4">
            También puede reclamar directamente a la Agencia Española de Protección de Datos (AEPD)
          ...
          <p className="mb-4">
            ...
            Datos Personales en el siguiente enlace:{" "}
            <a
