      ...
      >
        <div className="space-y-3">
          <button
            ...
            disabled={submitting}
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-black text-white font-semibold text-sm border border-white/20 shadow-sm hover:bg-[#1a1a1a] transition disabled:opacity-60"
          >
            <AppleLogo />
            {t("appFlow.auth.apple")}
          </button>
          <button
            type="button"
